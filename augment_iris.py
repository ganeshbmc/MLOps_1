...
additional_rows = df.groupby('species').apply(lambda x: x.sample(30, replace=True)).reset_index(drop=True)
...
print('iris.csv dataset augmented with 90 more rows. Shape {augmented_df.shape}')
